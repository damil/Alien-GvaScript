...
CustomButtons - Manage buttons creation, styling and keyboard navigation
...
Buttons in there different states (idle, focus and hover) are easily styled using css classes.
