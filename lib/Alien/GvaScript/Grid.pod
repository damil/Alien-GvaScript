...
A unique id to identify a Grid.  Might be later used in Grids.get(id) to retrieve the grid instance.
...
Data trasfer Object to the AJAX request. C<Ex: {param1: 'value1', param2: 'value2'}>
...
a space-separated list of css classes to be given to the column cells.
