...
Diffs from web-forms spec
  - distinguish "repeat section" and "repetition block"

TODO
  - serialize (json encoding)

  - deserialize (fill form)
  ...
  - "onrepeat" event (after adding a repetition block)

  - autofocus

  - interactin with TreeNav (initSubTree).
